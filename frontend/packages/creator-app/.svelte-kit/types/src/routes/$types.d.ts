...
type LayoutRouteId = RouteId | "/" | "/admin" | "/assistants" | "/evaluaitor" | "/evaluaitor/[rubricId]" | "/knowledgebases" | "/org-admin" | "/prompt-templates" | null
type LayoutParams = RouteParams & { rubricId?: string }
