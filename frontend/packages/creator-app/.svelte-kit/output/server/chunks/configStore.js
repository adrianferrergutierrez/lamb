import { w as writable, j as derived } from "./exports.js";
...
function getPossibleLocales(refLocale, fallbackLocale2 = getOptions().fallbackLocale) {
  const locales = getSubLocales(refLocale);
  if (fallbackLocale2) {
    return [.../* @__PURE__ */ new Set([...locales, ...getSubLocales(fallbackLocale2)])];
  }
  return locales;
}
