...
supportedLocales.forEach((lang) => {
  registerLocaleLoader(lang, () => __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "../locales/ca.json": () => import("../../chunks/ca.js"), "../locales/en.json": () => import("../../chunks/en.js"), "../locales/es.json": () => import("../../chunks/es.js"), "../locales/eu.json": () => import("../../chunks/eu.js") }), `../locales/${lang}.json`, 3));
});
({
...
function _layout($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    let { children } = $$props;
    $$renderer2.push(`<div class="min-h-screen bg-gray-50 text-gray-900 font-sans">`);
    children($$renderer2);
    $$renderer2.push(`<!----></div>`);
  });
}
